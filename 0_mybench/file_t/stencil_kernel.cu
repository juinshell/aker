...
__global__ void ori_stencil_int(int c0,int c1,int *A0,int *Anext, int nx, int ny, int nz, int iteration)
{
    for (int loop = 0; loop < iteration; loop++) {
        ...
        //register for bottom and top planes
        //because of thread coarsening, we need to doulbe registers
        int bottom=0.0f,bottom2=0.0f,top=0.0f,top2=0.0f;
