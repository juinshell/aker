...
// Description:	Dot
// Input:
//	- name: bert_Tanh_389_0	type: float	shape: Shape{128, 1024}
//	- name: bert_Constant_111_0	type: float	shape: Shape{1024, 1001}
// Output:
//	- name: bert_Dot_390_0	type: float	shape: Shape{128, 1001}
...
//	- name: bert_Dot_179_0	type: float	shape: Shape{16384, 1024}
// Output:
//	- name: bert_Add_185_0	type: float	shape: Shape{16384, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_184<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_32_0, Broadcast_184_0);
// Add_float_float_float_cuda_Add_185<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_Dot_179_0, Broadcast_184_0, bert_Add_185_0);
...
// Description:	Sum
// Input:
//	- name: bert_Add_142_0	type: float	shape: Shape{128, 128, 1024}
// Output:
//	- name: bert_Sum_149_0	type: float	shape: Shape{128, 128}
...
// Input:
//	- name: bert_Reshape_126_0	type: float	shape: Shape{128, 128}
// Output:
//	- name: bert_Broadcast_127_0	type: float	shape: Shape{128, 128, 128}
...
// Description:	Broadcast
// Input:
//	- name: bert_Reshape_195_0	type: float	shape: Shape{128, 128, 128}
// Output:
//	- name: bert_Broadcast_196_0	type: float	shape: Shape{128, 16, 128, 128}
...
// Output:
//	- name: bert_Broadcast_116_0	type: float	shape: Shape{128, 128, 1}
...
// Output:
//	- name: bert_Broadcast_391_0	type: float	shape: Shape{128, 1001}
...
// Input:
// Output:
//	- name: bert_Constant_357_0	type: float	shape: Shape{16384}
...
// Input:
// Output:
//	- name: bert_Constant_158_0	type: float	shape: Shape{128, 128}
...
// Input:
// Output:
//	- name: bert_Constant_318_0	type: float	shape: Shape{16384}
...
// Input:
// Output:
//	- name: bert_Constant_150_0	type: float	shape: Shape{128, 128}
...
// Input:
// Output:
//	- name: bert_Constant_215_0	type: float	shape: Shape{16384}
...
//	- name: bert_Reshape_153_0	type: float	shape: Shape{128, 128}
//	- name: bert_Reshape_165_0	type: float	shape: Shape{128, 128}
//	- name: bert_Constant_19_0	type: float	shape: Shape{1024}
//	- name: bert_Add_142_0	type: float	shape: Shape{128, 128, 1024}
// Output:
//	- name: bert_Add_175_0	type: float	shape: Shape{128, 128, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_173<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_18_0, Broadcast_173_0);
// Broadcast_float_float_cuda_Broadcast_154<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_153_0, Broadcast_154_0);
// Broadcast_float_float_cuda_Broadcast_166<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_165_0, Broadcast_166_0);
// Broadcast_float_float_cuda_Broadcast_167<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_19_0, Broadcast_167_0);
...
// Multiply_float_float_float_cuda_Multiply_169<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_Add_142_0, Multiply_168_0, Multiply_169_0);
// Add_float_float_float_cuda_Add_175<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(Multiply_169_0, Subtract_174_0, bert_Add_175_0);
...
// Input:
// Output:
//	- name: bert_Constant_207_0	type: float	shape: Shape{16384}
...
// Input:
// Output:
//	- name: bert_Constant_262_0	type: float	shape: Shape{16384}
...
// Input:
// Output:
//	- name: bert_Constant_254_0	type: float	shape: Shape{16384}
...
// Input:
//	- name: bert_Constant_37_0	type: float	shape: Shape{}
//	- name: bert_BatchMatMul_192_0	type: float	shape: Shape{128, 16, 128, 128}
//	- name: bert_Broadcast_196_0	type: float	shape: Shape{128, 16, 128, 128}
// Output:
//	- name: bert_Add_197_0	type: float	shape: Shape{128, 16, 128, 128}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_193<<<dim3(524288, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_37_0, Broadcast_193_0);
// Multiply_float_float_float_cuda_Multiply_194<<<dim3(65536, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_BatchMatMul_192_0, Broadcast_193_0, Multiply_194_0);
// Add_float_float_float_cuda_Add_197<<<dim3(65536, 1, 1), dim3(512, 1, 1), 0, 0>>>(Multiply_194_0, bert_Broadcast_196_0, bert_Add_197_0);
...
// Input:
// Output:
//	- name: bert_Constant_310_0	type: float	shape: Shape{16384}
...
// Description:	OneHot
// Input:
//	- name: bert_Reshape_114_0	type: int32_t	shape: Shape{16384}
// Output:
//	- name: bert_OneHot_118_0	type: float	shape: Shape{16384, 2}
...
//	- name: bert_Add_142_0	type: float	shape: Shape{128, 128, 1024}
// Output:
//	- name: bert_Multiply_156_0	type: float	shape: Shape{128, 128, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_154<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_153_0, Broadcast_154_0);
// Subtract_float_float_float_cuda_Subtract_155<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_Add_142_0, Broadcast_154_0, Subtract_155_0);
// Multiply_float_float_float_cuda_Multiply_156<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(Subtract_155_0, Subtract_155_0, bert_Multiply_156_0);
...
// Description:	Softmax
// Input:
//	- name: bert_Add_392_0	type: float	shape: Shape{128, 1001}
// Output:
//	- name: bert_Softmax_393_0	type: float	shape: Shape{128, 1001}
...
// Input:
//	- name: bert_Reshape_189_0	type: float	shape: Shape{128, 16, 128, 64}
//	- name: bert_Reshape_190_0	type: float	shape: Shape{128, 16, 128, 64}
// Output:
//	- name: bert_BatchMatMul_192_0	type: float	shape: Shape{128, 16, 128, 128}
...
// Node name:	 Elementwise Kernel Fusion
// Input:
//	- name: bert_GatherV2_121_0	type: float	shape: Shape{16384, 1024}
//	- name: bert_Dot_122_0	type: float	shape: Shape{16384, 1024}
...
// Broadcast_float_float_cuda_Broadcast_141<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_140_0, Broadcast_141_0);
// Add_float_float_float_cuda_Add_142<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_133_0, Broadcast_141_0, bert_Add_142_0);
...
// Description:	Dot
// Input:
//	- name: bert_Reshape_176_0	type: float	shape: Shape{16384, 1024}
...
// Description:	Reshape
// Input:
//	- name: bert_Reshape_188_0	type: float	shape: Shape{128, 128, 16, 64}
// Output:
//	- name: bert_Reshape_191_0	type: float	shape: Shape{128, 16, 128, 64}
...
//	- name: bert_Constant_150_0	type: float	shape: Shape{128, 128}
// Output:
//	- name: bert_Divide_151_0	type: float	shape: Shape{128, 128}
...
// Input:
//	- name: bert_Constant_4_0	type: float	shape: Shape{30522, 1024}
//	- name: bert_Reshape_117_0	type: int32_t	shape: Shape{16384}
// Output:
//	- name: bert_GatherV2_121_0	type: float	shape: Shape{16384, 1024}
...
//	- name: bert_Constant_55_0	type: float	shape: Shape{}
//	- name: bert_Constant_53_0	type: float	shape: Shape{4096}
//	- name: bert_Dot_233_0	type: float	shape: Shape{16384, 4096}
//	- name: bert_Constant_54_0	type: float	shape: Shape{}
// Output:
//	- name: bert_Multiply_248_0	type: float	shape: Shape{16384, 4096}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_246<<<dim3(1048576, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_58_0, Broadcast_246_0);
// Broadcast_float_float_cuda_Broadcast_244<<<dim3(1048576, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_57_0, Broadcast_244_0);
// Broadcast_float_float_cuda_Broadcast_241<<<dim3(1048576, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_56_0, Broadcast_241_0);
// Broadcast_float_float_cuda_Broadcast_238<<<dim3(1048576, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_55_0, Broadcast_238_0);
// Broadcast_float_float_cuda_Broadcast_234<<<dim3(1048576, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_53_0, Broadcast_234_0);
// Add_float_float_float_cuda_Add_235<<<dim3(131072, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_Dot_233_0, Broadcast_234_0, Add_235_0);
// Broadcast_float_float_cuda_Broadcast_236<<<dim3(1048576, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_54_0, Broadcast_236_0);
...
// Multiply_float_float_float_cuda_Multiply_248<<<dim3(131072, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_235_0, Multiply_247_0, bert_Multiply_248_0);
...
// Input:
//	- name: bert_Constant_46_0	type: float	shape: Shape{1024}
//	- name: bert_Dot_202_0	type: float	shape: Shape{16384, 1024}
//	- name: bert_Reshape_176_0	type: float	shape: Shape{16384, 1024}
// Output:
//	- name: bert_Add_205_0	type: float	shape: Shape{16384, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_203<<<dim3(262144, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_46_0, Broadcast_203_0);
// Add_float_float_float_cuda_Add_204<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_Dot_202_0, Broadcast_203_0, Add_204_0);
// Add_float_float_float_cuda_Add_205<<<dim3(32768, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_204_0, bert_Reshape_176_0, bert_Add_205_0);
...
// Input:
//	- name: bert_Constant_110_0	type: float	shape: Shape{1024}
//	- name: bert_Dot_386_0	type: float	shape: Shape{128, 1024}
// Output:
//	- name: bert_Tanh_389_0	type: float	shape: Shape{128, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_387<<<dim3(2048, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Constant_110_0, Broadcast_387_0);
// Add_float_float_float_cuda_Add_388<<<dim3(256, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_Dot_386_0, Broadcast_387_0, Add_388_0);
// Tanh_float_float_cuda_Tanh_389<<<dim3(256, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_388_0, bert_Tanh_389_0);
...
// Description:	Convert
// Input:
//	- name: bert_Reshape_115_0	type: int32_t	shape: Shape{128, 1, 128}
// Output:
//	- name: bert_Convert_120_0	type: float	shape: Shape{128, 1, 128}
...
//	- name: bert_Reshape_124_0	type: float	shape: Shape{128, 128}
//	- name: bert_Broadcast_127_0	type: float	shape: Shape{128, 128, 128}
...
// Output:
//	- name: bert_Multiply_148_0	type: float	shape: Shape{128, 1, 128, 128}
//	- name: bert_Multiply_145_0	type: float	shape: Shape{128, 1, 128, 128}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_135<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_134_0, Broadcast_135_0);
// Broadcast_float_float_cuda_Broadcast_125<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_124_0, Broadcast_125_0);
// Multiply_float_float_float_cuda_Multiply_128<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_125_0, bert_Broadcast_127_0, Multiply_128_0);
...
// Broadcast_float_float_cuda_Broadcast_144<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_143_0, Broadcast_144_0);
// Multiply_float_float_float_cuda_Multiply_145<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Subtract_136_0, Broadcast_144_0, bert_Multiply_145_0);
// Broadcast_float_float_cuda_Broadcast_138<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_137_0, Broadcast_138_0);
// Subtract_float_float_float_cuda_Subtract_139<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_138_0, Reshape_131_0, Subtract_139_0);
// Broadcast_float_float_cuda_Broadcast_147<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_146_0, Broadcast_147_0);
// Multiply_float_float_float_cuda_Multiply_148<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Subtract_139_0, Broadcast_147_0, bert_Multiply_148_0);
...
// Description:	Dot
// Input:
//	- name: bert_Reshape_385_0	type: float	shape: Shape{128, 1024}
//	- name: bert_Constant_109_0	type: float	shape: Shape{1024, 1024}
// Output:
//	- name: bert_Dot_386_0	type: float	shape: Shape{128, 1024}
...
//	- name: bert_Add_197_0	type: float	shape: Shape{128, 16, 128, 128}
// Output:
//	- name: bert_Softmax_198_0	type: float	shape: Shape{128, 16, 128, 128}
...
// Node name:	 Elementwise Kernel Fusion
// Input:
//	- name: bert_Sum_157_0	type: float	shape: Shape{128, 128}
//	- name: bert_Constant_158_0	type: float	shape: Shape{128, 128}
//	- name: bert_Reshape_161_0	type: float	shape: Shape{1}
// Output:
//	- name: bert_Rsqrt_164_0	type: float	shape: Shape{128, 128, 1}
// Fused functions:
// Divide_float_float_float_cuda_Divide_159<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(bert_Sum_157_0, bert_Constant_158_0, Divide_159_0);
// Reshape_float_float_cuda_lib_Reshape_160(Divide_159_0, Reshape_160_0);
// Broadcast_float_float_cuda_Broadcast_162<<<dim3(256, 1, 1), dim3(64, 1, 1), 0, 0>>>(bert_Reshape_161_0, Broadcast_162_0);
// Add_float_float_float_cuda_Add_163<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Reshape_160_0, Broadcast_162_0, Add_163_0);
// Rsqrt_float_float_cuda_Rsqrt_164<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_163_0, bert_Rsqrt_164_0);
...
// Description:	Slice
// Input:
//	- name: bert_Reshape_383_0	type: float	shape: Shape{128, 128, 1024}
// Output:
//	- name: bert_Slice_384_0	type: float	shape: Shape{128, 1, 1024}
...
// Input:
// Output:
//	- name: bert_Constant_365_0	type: float	shape: Shape{16384}
...
//	- name: bert_Constant_59_0	type: float	shape: Shape{4096, 1024}
// Output:
//	- name: bert_Dot_249_0	type: float	shape: Shape{16384, 1024}
...
//	- name: bert_Reshape_191_0	type: float	shape: Shape{128, 16, 128, 64}
// Output:
//	- name: bert_BatchMatMul_199_0	type: float	shape: Shape{128, 16, 128, 64}
...
//	- name: bert_BatchMatMul_199_0	type: float	shape: Shape{128, 16, 128, 64}
// Output:
//	- name: bert_Reshape_200_0	type: float	shape: Shape{128, 128, 16, 64}
...
// Output:
//	- name: bert_Add_392_0	type: float	shape: Shape{128, 1001}
extern "C" __launch_bounds__(128) __global__ void bert_Add_float_float_float_cuda_Add_392(float* input0, float* input1, float* output0)
{
...
// Description:	Dot
// Input:
//	- name: bert_Add_232_0	type: float	shape: Shape{16384, 1024}
//	- name: bert_Constant_52_0	type: float	shape: Shape{1024, 4096}
// Output:
//	- name: bert_Dot_233_0	type: float	shape: Shape{16384, 4096}
...
CUDA_SAFE_CALL(cudaMalloc((void**)&bert_group_0_CUDA_GPU0_allocator_memory_pool,696451072));
CUDA_SAFE_CALL(cudaMemset((void*)bert_group_0_CUDA_GPU0_allocator_memory_pool, 0, 696451072));
bert_Reshape_114_0 = (int32_t*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+0);
bert_OneHot_118_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Dot_122_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+196608);
...
bert_GatherV2_121_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67305472);
bert_Add_142_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134414336);
...
bert_Multiply_156_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Sum_157_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67174400);
bert_Rsqrt_164_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Reshape_165_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Add_175_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+131072);
bert_Reshape_176_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+131072);
bert_Dot_179_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Add_185_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Reshape_188_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Reshape_191_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Dot_178_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Add_183_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+201457664);
bert_Reshape_187_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+201457664);
bert_Reshape_190_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Dot_177_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+201457664);
bert_Add_181_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+268566528);
bert_Reshape_186_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+268566528);
bert_Reshape_189_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+201457664);
bert_BatchMatMul_192_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+268566528);
...
bert_Reshape_115_0 = (int32_t*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Convert_120_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Reshape_126_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Broadcast_127_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134414336);
bert_Multiply_145_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+142802944);
bert_Multiply_148_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+151191552);
bert_Reshape_195_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+142802944);
bert_Broadcast_196_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+402784256);
bert_Add_197_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+537001984);
bert_Softmax_198_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+537001984);
bert_BatchMatMul_199_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Reshape_200_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Reshape_201_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Dot_202_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Add_205_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
...
bert_Multiply_213_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Sum_214_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67174400);
bert_Rsqrt_221_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Reshape_222_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Add_232_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+131072);
bert_Dot_233_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Multiply_248_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+428015616);
bert_Dot_249_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Add_252_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
...
bert_Multiply_260_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Sum_261_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67174400);
bert_Rsqrt_268_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Reshape_269_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Add_279_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+131072);
bert_Dot_282_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Add_288_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Reshape_291_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Reshape_294_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Dot_281_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Add_286_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+226689024);
bert_Reshape_290_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+226689024);
bert_Reshape_293_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Dot_280_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+226689024);
bert_Add_284_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+293797888);
bert_Reshape_289_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+293797888);
bert_Reshape_292_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+226689024);
bert_BatchMatMul_295_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+293797888);
bert_Reshape_298_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+151191552);
bert_Broadcast_299_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+159580160);
bert_Add_300_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+428015616);
bert_Softmax_301_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+428015616);
bert_BatchMatMul_302_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Reshape_303_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Reshape_304_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Dot_305_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
bert_Add_308_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
...
bert_Multiply_316_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Sum_317_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67174400);
bert_Rsqrt_324_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Reshape_325_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Add_335_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+131072);
bert_Dot_336_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Multiply_351_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+335675392);
bert_Dot_352_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Add_355_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+134348800);
...
bert_Multiply_363_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Sum_364_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67174400);
bert_Rsqrt_371_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Reshape_372_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+65536);
bert_Add_382_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+131072);
bert_Reshape_383_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+131072);
bert_Slice_384_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Reshape_385_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+67239936);
bert_Dot_386_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+0);
bert_Tanh_389_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+524288);
bert_Dot_390_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+0);
bert_Broadcast_391_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+512512);
bert_Add_392_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+0);
bert_Softmax_393_0 = (float*)(bert_group_0_CUDA_GPU0_allocator_memory_pool+512512);

CUDA_SAFE_CALL(cudaMalloc((void**)&bert_group_persist_CUDA_GPU0_allocator_memory_pool,236860736));
CUDA_SAFE_CALL(cudaMemset((void*)bert_group_persist_CUDA_GPU0_allocator_memory_pool, 0, 236860736));
...
bert_Constant_22_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+135598080);
bert_Reshape_161_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+135598080);
bert_Constant_158_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+135598144);
bert_Constant_37_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+135663680);
bert_Constant_30_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+135663744);
bert_Constant_29_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+135667840);
bert_Constant_28_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+139862144);
bert_Constant_27_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+139866240);
bert_Constant_79_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060544);
bert_Reshape_146_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060544);
bert_Constant_40_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060608);
bert_Reshape_143_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060608);
bert_Constant_78_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060672);
bert_Reshape_137_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060672);
bert_Constant_39_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060736);
bert_Reshape_134_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060736);
bert_Constant_25_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060800);
bert_Constant_45_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+144060864);
bert_Constant_48_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148255168);
bert_Constant_47_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148259264);
bert_Constant_207_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148263360);
bert_Constant_51_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148328896);
bert_Reshape_218_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148328896);
bert_Constant_215_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148328960);
bert_Constant_60_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148394496);
bert_Constant_58_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148398592);
bert_Constant_56_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148398656);
bert_Constant_55_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148398720);
bert_Constant_53_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148398784);
bert_Constant_57_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148415168);
bert_Constant_54_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148415232);
bert_Constant_52_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+148415296);
bert_Constant_59_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+165192512);
bert_Constant_62_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+181969728);
bert_Constant_61_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+181973824);
bert_Constant_254_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+181977920);
bert_Constant_65_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+182043456);
bert_Reshape_265_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+182043456);
bert_Constant_262_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+182043520);
bert_Constant_85_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+182109056);
bert_Constant_71_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+182113152);
bert_Constant_70_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+182117248);
bert_Constant_76_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+186311552);
bert_Constant_69_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+186311616);
bert_Constant_68_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+186315712);
bert_Constant_67_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+190510016);
bert_Constant_66_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+190514112);
bert_Constant_84_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+194708416);
bert_Constant_87_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+198902720);
bert_Constant_86_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+198906816);
bert_Constant_310_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+198910912);
bert_Constant_90_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+198976448);
bert_Reshape_321_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+198976448);
bert_Constant_318_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+198976512);
bert_Constant_99_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199042048);
bert_Constant_97_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199046144);
bert_Constant_95_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199046208);
bert_Constant_94_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199046272);
bert_Constant_92_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199046336);
bert_Constant_96_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199062720);
bert_Constant_93_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199062784);
bert_Constant_91_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+199062848);
bert_Constant_98_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+215840064);
bert_Constant_101_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+232617280);
bert_Constant_100_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+232621376);
bert_Constant_357_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+232625472);
bert_Constant_104_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+232691008);
bert_Reshape_368_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+232691008);
bert_Constant_365_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+232691072);
bert_Constant_111_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+232756608);
bert_Constant_112_0 = (float*)(bert_group_persist_CUDA_GPU0_allocator_memory_pool+236856704);
    ...
    void Dot_float_float_float_cuda_lib_Dot_122(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(mycublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 16384, 2, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 2, &beta, static_cast<float*>(output0), 1024));
    ...
    void Dot_float_float_float_cuda_lib_Dot_179(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(mycublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 16384, 1024, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 1024));
    ...
    void Dot_float_float_float_cuda_lib_Dot_233(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(mycublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 4096, 16384, 1024, &alpha, static_cast<const float*>(input1), 4096, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 4096));
    ...
    void Dot_float_float_float_cuda_lib_Dot_249(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(mycublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 16384, 4096, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 4096, &beta, static_cast<float*>(output0), 1024));
    ...
    void Dot_float_float_float_cuda_lib_Dot_386(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(mycublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 128, 1024, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 1024));
    ...
    void Dot_float_float_float_cuda_lib_Dot_390(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(mycublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1001, 128, 1024, &alpha, static_cast<const float*>(input1), 1001, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 1001));
...
void Bert::gen_vector(int32_t*  Parameter_0_0, int32_t*  Parameter_1_0, int32_t*  Parameter_2_0, float**  Result_394_0) {
    ...
    kernels.emplace_back(new bert_OneHot_int32_t_float_cuda_OneHot_118_CallKernel(dim3(256, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_114_0), std::move(bert_OneHot_118_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_GatherV2_float_int32_t_float_cuda_GatherV2_121_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Constant_4_0), std::move(bert_Reshape_117_0), std::move(bert_GatherV2_121_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Reshape_Reshape_Add_Broadcast_Add_0_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_GatherV2_121_0), std::move(bert_Dot_122_0), std::move(bert_Reshape_140_0), std::move(bert_Add_142_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Add_142_0), std::move(bert_Sum_149_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Divide_float_float_float_cuda_Divide_151_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_149_0), std::move(bert_Constant_150_0), std::move(bert_Divide_151_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Reshape_153_0), std::move(bert_Add_142_0), std::move(bert_Multiply_156_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Multiply_156_0), std::move(bert_Sum_157_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_157_0), std::move(bert_Constant_158_0), std::move(bert_Reshape_161_0), std::move(bert_Rsqrt_164_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_18_0), std::move(bert_Reshape_153_0), std::move(bert_Reshape_165_0), std::move(bert_Constant_19_0), std::move(bert_Add_142_0), std::move(bert_Add_175_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Add_7_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_32_0), std::move(bert_Dot_179_0), std::move(bert_Add_185_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_191_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_188_0), std::move(bert_Reshape_191_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Add_7_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_30_0), std::move(bert_Dot_178_0), std::move(bert_Add_183_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_191_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_187_0), std::move(bert_Reshape_190_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Add_7_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_28_0), std::move(bert_Dot_177_0), std::move(bert_Add_181_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_191_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_186_0), std::move(bert_Reshape_189_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_Broadcast_float_float_cuda_Broadcast_116_CallKernel(dim3(256, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Constant_25_0), std::move(bert_Broadcast_116_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_Convert_int32_t_float_cuda_Convert_120_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Reshape_115_0), std::move(bert_Convert_120_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Broadcast_float_float_cuda_Broadcast_127_CallKernel(dim3(32768, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_126_0), std::move(bert_Broadcast_127_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Multiply_Reshape_Subtract_Broadcast_Multiply_Broadcast_Subtract_Broadcast_Multiply_1_CallKernel(dim3(4096, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Reshape_134_0), std::move(bert_Reshape_124_0), std::move(bert_Broadcast_127_0), std::move(bert_Reshape_143_0), std::move(bert_Reshape_137_0), std::move(bert_Reshape_146_0), std::move(bert_Multiply_148_0), std::move(bert_Multiply_145_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Broadcast_float_float_cuda_Broadcast_196_CallKernel(dim3(524288, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_195_0), std::move(bert_Broadcast_196_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Broadcast_Multiply_Add_8_CallKernel(dim3(65536, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_37_0), std::move(bert_BatchMatMul_192_0), std::move(bert_Broadcast_196_0), std::move(bert_Add_197_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_200_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_BatchMatMul_199_0), std::move(bert_Reshape_200_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_46_0), std::move(bert_Dot_202_0), std::move(bert_Reshape_176_0), std::move(bert_Add_205_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Add_205_0), std::move(bert_Sum_206_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Divide_float_float_float_cuda_Divide_151_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_206_0), std::move(bert_Constant_207_0), std::move(bert_Divide_208_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Reshape_210_0), std::move(bert_Add_205_0), std::move(bert_Multiply_213_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Multiply_213_0), std::move(bert_Sum_214_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_214_0), std::move(bert_Constant_215_0), std::move(bert_Reshape_218_0), std::move(bert_Rsqrt_221_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_47_0), std::move(bert_Reshape_210_0), std::move(bert_Reshape_222_0), std::move(bert_Constant_48_0), std::move(bert_Add_205_0), std::move(bert_Add_232_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Broadcast_Add_Broadcast_Power_Multiply_Add_Multiply_Tanh_Add_Multiply_Multiply_13_CallKernel(dim3(131072, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_58_0), std::move(bert_Constant_57_0), std::move(bert_Constant_56_0), std::move(bert_Constant_55_0), std::move(bert_Constant_53_0), std::move(bert_Dot_233_0), std::move(bert_Constant_54_0), std::move(bert_Multiply_248_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_60_0), std::move(bert_Dot_249_0), std::move(bert_Add_232_0), std::move(bert_Add_252_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Add_252_0), std::move(bert_Sum_253_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Divide_float_float_float_cuda_Divide_151_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_253_0), std::move(bert_Constant_254_0), std::move(bert_Divide_255_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Reshape_257_0), std::move(bert_Add_252_0), std::move(bert_Multiply_260_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Multiply_260_0), std::move(bert_Sum_261_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_261_0), std::move(bert_Constant_262_0), std::move(bert_Reshape_265_0), std::move(bert_Rsqrt_268_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_61_0), std::move(bert_Reshape_257_0), std::move(bert_Reshape_269_0), std::move(bert_Constant_62_0), std::move(bert_Add_252_0), std::move(bert_Add_279_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Add_7_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_71_0), std::move(bert_Dot_282_0), std::move(bert_Add_288_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_191_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_291_0), std::move(bert_Reshape_294_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Add_7_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_69_0), std::move(bert_Dot_281_0), std::move(bert_Add_286_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_191_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_290_0), std::move(bert_Reshape_293_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Add_7_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_67_0), std::move(bert_Dot_280_0), std::move(bert_Add_284_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_191_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_289_0), std::move(bert_Reshape_292_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_Broadcast_float_float_cuda_Broadcast_196_CallKernel(dim3(524288, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_298_0), std::move(bert_Broadcast_299_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Broadcast_Multiply_Add_8_CallKernel(dim3(65536, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_76_0), std::move(bert_BatchMatMul_295_0), std::move(bert_Broadcast_299_0), std::move(bert_Add_300_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_Reshape_float_float_cuda_Reshape_200_CallKernel(dim3(262144, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_BatchMatMul_302_0), std::move(bert_Reshape_303_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_85_0), std::move(bert_Dot_305_0), std::move(bert_Add_279_0), std::move(bert_Add_308_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Add_308_0), std::move(bert_Sum_309_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Divide_float_float_float_cuda_Divide_151_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_309_0), std::move(bert_Constant_310_0), std::move(bert_Divide_311_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Reshape_313_0), std::move(bert_Add_308_0), std::move(bert_Multiply_316_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Multiply_316_0), std::move(bert_Sum_317_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_317_0), std::move(bert_Constant_318_0), std::move(bert_Reshape_321_0), std::move(bert_Rsqrt_324_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_86_0), std::move(bert_Reshape_313_0), std::move(bert_Reshape_325_0), std::move(bert_Constant_87_0), std::move(bert_Add_308_0), std::move(bert_Add_335_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_99_0), std::move(bert_Dot_352_0), std::move(bert_Add_335_0), std::move(bert_Add_355_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Add_355_0), std::move(bert_Sum_356_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Divide_float_float_float_cuda_Divide_151_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_356_0), std::move(bert_Constant_357_0), std::move(bert_Divide_358_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Reshape_360_0), std::move(bert_Add_355_0), std::move(bert_Multiply_363_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Sum_float_float_cuda_Sum_149_CallKernel(dim3(16384, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Multiply_363_0), std::move(bert_Sum_364_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_CallKernel(dim3(32, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Sum_364_0), std::move(bert_Constant_365_0), std::move(bert_Reshape_368_0), std::move(bert_Rsqrt_371_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_CallKernel(dim3(32768, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_100_0), std::move(bert_Reshape_360_0), std::move(bert_Reshape_372_0), std::move(bert_Constant_101_0), std::move(bert_Add_355_0), std::move(bert_Add_382_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Slice_float_float_cuda_Slice_384_CallKernel(dim3(2048, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Reshape_383_0), std::move(bert_Slice_384_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_FusedKernel_float_float_float_cuda_Broadcast_Add_Tanh_31_CallKernel(dim3(256, 1, 1), dim3(512, 1, 1), 0, nullptr, std::move(bert_Constant_110_0), std::move(bert_Dot_386_0), std::move(bert_Tanh_389_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    ...
    kernels.emplace_back(new bert_Broadcast_float_float_cuda_Broadcast_391_CallKernel(dim3(2002, 1, 1), dim3(64, 1, 1), 0, nullptr, std::move(bert_Constant_112_0), std::move(bert_Broadcast_391_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
    kernels.emplace_back(new bert_Add_float_float_float_cuda_Add_392_CallKernel(dim3(1001, 1, 1), dim3(128, 1, 1), 0, nullptr, std::move(bert_Dot_390_0), std::move(bert_Broadcast_391_0), std::move(bert_Add_392_0), std::move(Parameter_0_0), std::move(Parameter_1_0), std::move(Parameter_2_0), std::move(Result_394_0)));
